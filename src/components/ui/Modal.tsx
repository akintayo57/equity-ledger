      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden bg-slate-900/90 border border-slate-800 backdrop-blur-lg rounded-2xl shadow-2xl text-white z-10"
          >
            {/* Header */}
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm overflow-hidden bg-slate-900/95 border border-slate-800 backdrop-blur-lg rounded-2xl shadow-2xl text-white z-10 p-6"
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="flex items-center space-x-3 w-full pt-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-medium rounded-xl transition-colors border border-slate-700"
                >
                  {cancelText}
                </button>
                <button
