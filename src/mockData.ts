...
export const initialSecurities: Security[] = [
  ...
  { id: 'sec-3', companyName: 'Banks DIH', ticker: 'DIH', exchange: 'GASCI', country: 'Guyana', currency: 'GYD', sector: 'Consumer Staples', status: 'ACTIVE', fundamentals: { peRatio: 8.5, eps: 14.1, dividendYield: 4.2, pbRatio: 1.1, roe: 11.2, lastUpdated: '2023-12-31' } },
  { id: 'sec-4', companyName: 'Demerara Distillers', ticker: 'DDL', exchange: 'GASCI', country: 'Guyana', currency: 'GYD', sector: 'Consumer Staples', status: 'ACTIVE', fundamentals: { peRatio: 10.2, eps: 17.5, dividendYield: 2.8, pbRatio: 1.5, roe: 13.5, lastUpdated: '2023-12-31' } },
